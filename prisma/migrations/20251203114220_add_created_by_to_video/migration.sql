...
INSERT INTO "new_Video" ("ageBadge", "categoryId", "coverUrl", "createdAt", "duration", "id", "isHd", "performer", "title", "type", "updatedAt", "videoUrl", "views") SELECT "ageBadge", "categoryId", "coverUrl", "createdAt", "duration", "id", "isHd", "performer", "title", "type", "updatedAt", "videoUrl", "views" FROM "Video";
DROP TABLE "Video";
